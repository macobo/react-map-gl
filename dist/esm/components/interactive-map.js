...
var InteractiveMap = (function(_PureComponent) {
  ...
  function InteractiveMap(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), '_onInteractionStateChange', function(
      interactionState
    ) {
    ...
    _defineProperty(_assertThisInitialized(_this), '_onViewportChange', function(
      viewState,
      interactionState,
      oldViewState
    ) {
