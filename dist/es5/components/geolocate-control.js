...
var GeolocateControl = (function(_BaseControl) {
  ...
  function GeolocateControl() {
    ...
    _this = (0, _possibleConstructorReturn2['default'])(
      this,
      (_getPrototypeOf2 = (0, _getPrototypeOf3['default'])(GeolocateControl)).call.apply(
        _getPrototypeOf2,
        [this].concat(args)
      )
    );
    ...
    (0, _defineProperty2['default'])(
      ...
      '_getBounds',
      function(position) {
        var center = new _mapboxgl['default'].LngLat(
    ...
    (0, _defineProperty2['default'])(
      ...
      function(position) {
        ...
        var onViewportChange =
          _this.props.onViewportChange || _this._context.onViewportChange || noop;
        var onViewStateChange =
          _this.props.onViewStateChange || _this._context.onViewStateChange || noop;
        onViewStateChange({
          viewState: viewState
        });
