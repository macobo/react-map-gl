...
var Popup = (function(_BaseControl) {
  ...
  function Popup() {
    ...
    _this = (0, _possibleConstructorReturn2['default'])(
      this,
      (_getPrototypeOf2 = (0, _getPrototypeOf3['default'])(Popup)).call.apply(
        _getPrototypeOf2,
        [this].concat(args)
      )
    );
  ...
  (0, _createClass2['default'])(Popup, [
    {
      ...
      value: function componentDidMount() {
        (0, _get2['default'])(
          (0, _getPrototypeOf3['default'])(Popup.prototype),
          'componentDidMount',
          this
        ).call(this);
        this.forceUpdate();
      ...
      value: function _getPosition(x, y) {
        ...
        if (content) {
          return dynamicPosition
            ? (0, _dynamicPosition.getDynamicPosition)({
                x: x,
                y: y,
                anchor: anchor,
                padding: tipSize,
    ...
    },
    {
      ...
      value: function _getContainerStyle(x, y, z, positionType) {
        ...
        var style = {
          position: 'absolute',
          transform: '\n        translate('
            .concat(-anchorPosition.x * 100, '%, ')
            .concat(-anchorPosition.y * 100, '%)\n        translate(')
            .concat(left, 'px, ')
            .concat(top, 'px)\n      '),
          display: undefined,
          zIndex: undefined
