...
var NavigationControl = (function(_BaseControl) {
  ...
  function NavigationControl(props) {
    ...
    _this = (0, _possibleConstructorReturn2['default'])(
      this,
      (0, _getPrototypeOf2['default'])(NavigationControl).call(this, props)
    );
  ...
  (0, _createClass2['default'])(NavigationControl, [
    {
      ...
      value: function _updateViewport(opts) {
        ...
        var viewState = Object.assign(
          ...
          _mapController.LINEAR_TRANSITION_PROPS
        );
        var onViewportChange =
          this.props.onViewportChange || this._context.onViewportChange || noop;
