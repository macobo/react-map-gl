...
var FullscreenControl = (function(_BaseControl) {
  ...
  function FullscreenControl() {
    ...
    _this = (0, _possibleConstructorReturn2['default'])(
      this,
      (_getPrototypeOf2 = (0, _getPrototypeOf3['default'])(FullscreenControl)).call.apply(
        _getPrototypeOf2,
        [this].concat(args)
      )
    );
  ...
  (0, _createClass2['default'])(FullscreenControl, [
    {
      ...
      value: function componentDidMount() {
        ...
        _globals.document.addEventListener(
    ...
    },
    {
      ...
      value: function componentWillUnmount() {
        _globals.document.removeEventListener(
          this._mapboxFullscreenControl._fullscreenchange,
          this._onFullscreenChange
        );
      }
