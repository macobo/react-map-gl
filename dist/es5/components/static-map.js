...
var StaticMap = (function(_PureComponent) {
  ...
  function StaticMap() {
    ...
    _this = (0, _possibleConstructorReturn2['default'])(
      this,
      (_getPrototypeOf2 = (0, _getPrototypeOf3['default'])(StaticMap)).call.apply(
        _getPrototypeOf2,
        [this].concat(args)
      )
    );
    ...
    [
      {
        ...
        value: function componentDidMount() {
          ...
          this._mapbox = new _mapbox['default'](
      ...
      },
      {
        ...
        value: function _renderOverlays(dimensions) {
          ...
          return (0, _react.createElement)(_mapContext['default'].Consumer, null, function(
            interactiveContext
          ) {
            var context = Object.assign({}, interactiveContext, {
              viewport: new _viewportMercatorProject['default'](
                Object.assign({}, _this2.props, _this2.props.viewState, {
                  width: width,
                  height: height
                })
              ),
      ...
      },
      {
        ...
        value: function render() {
          ...
          var visible =
            this.props.visible &&
            (0, _mapConstraints.checkVisibilityConstraints)(
              this.props.viewState || this.props,
