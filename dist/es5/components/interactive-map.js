...
var defaultProps = Object.assign(
  {},
  _staticMap['default'].defaultProps,
  _mapState.MAPBOX_LIMITS,
  _transitionManager['default'].defaultProps,
  {
...
var InteractiveMap = (function(_PureComponent) {
  ...
  function InteractiveMap(props) {
    ...
    _this = (0, _possibleConstructorReturn2['default'])(
      this,
      (0, _getPrototypeOf2['default'])(InteractiveMap).call(this, props)
    );
    ...
    (0, _defineProperty2['default'])(
      (0, _assertThisInitialized2['default'])(_this),
      '_onViewportChange',
      function(viewState, interactionState, oldViewState) {
