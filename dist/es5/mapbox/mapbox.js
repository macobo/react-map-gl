...
var propTypes = {
  ...
  mapStyle: _propTypes['default'].oneOfType([
...
function getAccessToken() {
  ...
  if (!accessToken && typeof process !== 'undefined') {
    accessToken =
      accessToken || process.env.MapboxAccessToken || process.env.REACT_APP_MAPBOX_ACCESS_TOKEN;
  }
  ...
  (0, _createClass2['default'])(Mapbox, [
    ...
    },
    {
      ...
      value: function _checkStyleSheet() {
        var mapboxVersion =
          arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '0.47.0';
        ...
        try {
          ...
          if (!isCssLoaded) {
            ...
            link.setAttribute(
              'href',
              'https://api.tiles.mapbox.com/mapbox-gl-js/v'.concat(mapboxVersion, '/mapbox-gl.css')
            );
