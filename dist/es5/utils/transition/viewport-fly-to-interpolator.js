...
var ViewportFlyToInterpolator = (function(_TransitionInterpolat) {
  ...
  function ViewportFlyToInterpolator() {
    ...
    _this = (0, _possibleConstructorReturn2['default'])(
      this,
      (_getPrototypeOf2 = (0, _getPrototypeOf3['default'])(ViewportFlyToInterpolator)).call.apply(
        _getPrototypeOf2,
        [this].concat(args)
      )
    );
  ...
  (0, _createClass2['default'])(ViewportFlyToInterpolator, [
    {
      ...
      value: function initializeProps(startProps, endProps) {
        ...
        for (
          ...
          endViewportProps[_key2] = (0, _transitionUtils.getEndValueByShortestPath)(
            _key2,
            _startValue,
            _endValue
          );
