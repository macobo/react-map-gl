...
var LinearInterpolator = (function(_TransitionInterpolat) {
  ...
  function LinearInterpolator() {
    ...
    _this = (0, _possibleConstructorReturn2['default'])(
      this,
      (0, _getPrototypeOf2['default'])(LinearInterpolator).call(this)
    );
  ...
  (0, _createClass2['default'])(LinearInterpolator, [
    {
      ...
      value: function initializeProps(startProps, endProps) {
        ...
        if (this.around) {
          ...
          var aroundLngLat = new _viewportMercatorProject['default'](startProps).unproject(
            this.around
          );
        ...
        try {
          for (
            var _iterator = this.propNames[Symbol.iterator](), _step;
            ...
            (0, _assert['default'])(
              (0, _transitionUtils.isValid)(startValue) && (0, _transitionUtils.isValid)(endValue),
              ''.concat(key, ' must be supplied for transition')
            );
            startViewportProps[key] = startValue;
            endViewportProps[key] = (0, _transitionUtils.getEndValueByShortestPath)(
              key,
              startValue,
              endValue
            );
    ...
    },
    {
      ...
      value: function interpolateProps(startProps, endProps, t) {
        ...
        try {
          for (
            var _iterator2 = this.propNames[Symbol.iterator](), _step2;
        ...
        if (endProps.around) {
          var _getMapCenterByLngLat = new _viewportMercatorProject['default'](
