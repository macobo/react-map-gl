...
var MapController = (function() {
  function MapController() {
    ...
    (0, _defineProperty2['default'])(
      this,
      '_transitionManager',
      new _transitionManager['default']()
    );
  ...
  (0, _createClass2['default'])(MapController, [
    ...
    },
    {
      ...
      value: function isFunctionKeyPressed(event) {
        ...
        return Boolean(
          srcEvent.metaKey || srcEvent.altKey || srcEvent.ctrlKey || srcEvent.shiftKey
        );
      }
    },
    {
    ...
    },
    {
      ...
      value: function getMapState(overrides) {
        return new _mapState['default'](
          Object.assign({}, this.mapStateProps, this._state, overrides)
        );
      }
    },
    {
      ...
      value: function setOptions(options) {
        var onViewportChange = options.onViewportChange,
          ...
          eventManager =
            _options$eventManager === void 0 ? this.eventManager : _options$eventManager,
          ...
          doubleClickZoom =
            _options$doubleClickZ === void 0 ? this.doubleClickZoom : _options$doubleClickZ,
